<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Java.aspx.cs" Inherits="Java" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineVarsityConnectionString %>" SelectCommand="SELECT [image], [bname], [qty], [AuthorName], [price] FROM [Data] WHERE (([qty] &gt; @qty) AND ([Subject] = @Subject))">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="Java" Name="Subject" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
